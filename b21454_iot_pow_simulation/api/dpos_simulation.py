...
def simulate():
    ...
    json_data = {"nodes": "http://localhost:4999", "stake": 31}
    ...
    json_data = {"nodes": "http://localhost:5010", "stake": 50}
    add_api = "http://localhost:4999/api/dpos/nodes/add"
    response = requests.post(url=add_api, json=json_data)
    print("dpos-eos-like-system 请求回应为:", response.text)
    ...
    json_data = {"nodes": "http://localhost:5011", "stake": 51}
    add_api = "http://localhost:4999/api/dpos/nodes/add"
    response = requests.post(url=add_api, json=json_data)
    print("dpos-eos-like-system 请求回应为:", response.text)
    ...
    json_data = {"nodes": "http://localhost:5012", "stake": 52}
    add_api = "http://localhost:4999/api/dpos/nodes/add"
    response = requests.post(url=add_api, json=json_data)
    print("dpos-eos-like-system 请求回应为:", response.text)
