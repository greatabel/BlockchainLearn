...
@swag_from(
    {
        ...
        "responses": {
            ...
            HTTPStatus.BAD_REQUEST.value: {"description": "Invalid transaction"},
        },
    },
    validation=True,
)
def new_transaction():
    ...
    transaction, valid = blockchain.create_transaction(
        values["sender"], values["recipient"], values["amount"]
    )

    if valid:
        response = {"message": "New transaction registered", "transaction": transaction}
