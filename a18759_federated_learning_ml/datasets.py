...
def get_dataset(dir, name):
    ...
    train_dataset = datasets.ImageFolder(
        "data/chest_xray/train", transform=transform_train
    )
    eval_dataset = datasets.ImageFolder("data/chest_xray//val", transform=transform_val)

    # ---- end --- -hardcode修改成肺炎数据集
