...
rects2 = ax.bar(x, women_means, width, label="central_acc2")
...
l1 = ax1.plot(central_acc1, markersize=marker_size, linestyle="--", linewidth=3)
l2 = ax1.plot(central_acc2, marker="v", markersize=marker_size)
l3 = ax1.plot(central_acc3, marker="o", markersize=marker_size)
l4 = ax1.plot(federate_acc1, marker="*", markersize=marker_size)
