...
def get_dataset(dir, name):
	...
	if name=='mnist':
		...
		transform_train = transforms.Compose([
		    ...
		    transforms.Grayscale(num_output_channels=3), # Add an extra channel to the input images
		    transforms.ToTensor(),
	    ...
	    train_dataset = datasets.FashionMNIST(dir, train=True, download=True,
	                                       transform=all_transforms)
	    eval_dataset = datasets.FashionMNIST(dir, train=False,
	                                      transform=all_transforms)
