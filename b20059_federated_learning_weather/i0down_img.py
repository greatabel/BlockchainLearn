...
class BaiduSpider:
    ...
    def saveImage(self, item, name):
        ...
        fileName = name + ".jpg"
        string = "data/%s/%s" % (self.path, fileName)
    ...
    def makeDir(self, path):
        ...
        E = os.path.exists(os.path.join("data", self.path))
        if not E:
            os.makedirs(os.path.join("data", self.path))
            os.chdir(os.path.join("data", self.path))
